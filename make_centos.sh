...
function cleanup_layout() {
    ...
    mv $DVD_LAYOUT/$REPODATA/*-comps-BaseOS.x86_64.xml $DVD_LAYOUT/BaseOS/Packages/comps.xml
...
function create_iso() {
    ...
    /usr/bin/createrepo -v -g comps.xml $DVD_LAYOUT/BaseOS/Packages -o $DVD_LAYOUT/BaseOS
